        ...
        <div class="sidebar pe-4 pb-3">
            <nav class="navbar bg-secondary navbar-dark">
                ...
                <div class="navbar-nav w-100">
                    <a href="/admin" class="nav-item nav-link" style="color:darkorange"><i class="nav-icon fas fa-home"></i>Ana Sayfa</a>
                    <div class="nav-item dropdown">
                        <a href="#" class="nav-link dropdown-toggle" data-bs-toggle="dropdown" style="color:dodgerblue"><i class="nav-icon fas fa-box-open text-blue"></i>Sipariş</a>
                        ...
                        <a href="/admin/category" class="nav-item nav-link" style="color:yellow; line-height: 20px;"><i class="nav-icon fas fa-th"></i>Kategori</a>
                        ...
                        <a href="/admin/connection" class="nav-item nav-link" style="color:palegreen"><i class="nav-icon fas fa-phone"></i>İletişim</a>
